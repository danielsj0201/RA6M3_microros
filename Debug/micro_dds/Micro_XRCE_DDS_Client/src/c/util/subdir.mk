...
C_SRCS += \
../micro_dds/Micro_XRCE_DDS_Client/src/c/util/ping.c \
../micro_dds/Micro_XRCE_DDS_Client/src/c/util/time.c 

OBJS += \
./micro_dds/Micro_XRCE_DDS_Client/src/c/util/ping.o \
./micro_dds/Micro_XRCE_DDS_Client/src/c/util/time.o 

C_DEPS += \
./micro_dds/Micro_XRCE_DDS_Client/src/c/util/ping.d \
./micro_dds/Micro_XRCE_DDS_Client/src/c/util/time.d 


# Each subdirectory must supply rules for building sources it contributes
micro_dds/Micro_XRCE_DDS_Client/src/c/util/%.o: ../micro_dds/Micro_XRCE_DDS_Client/src/c/util/%.c
	@echo 'Building file: $<'
